...
import { editItem, removeItem } from "@/features/cartSlice.ts";
import SelectProductAmount from "./SelectProductAmount.tsx.tsx";
import { Mode } from "./SelectProductAmount.tsx";
...
export const FourthColumn = ({ price }: { price: string }) => {
  return <p className="font-medium sm:ml-auto">{formatAsDollar(price)}</p>;
};
